        ...
        <div class="mt-6">
          ...
          <div class="flex w-full justify-center2 py-6">
            <nav aria-label="Footer Navigation - Support">
              <ul class="flex gap-6 ">
                <li>
                  <a href="{{ $facebook }}" rel="noreferrer" target="_blank" class="font-bold text-gray-900 transition hover:text-[#FF6D42]">
                ...
                <li>
                  <a href="{{ $instagram }}" rel="noreferrer" target="_blank" class="font-bold text-gray-900 transition hover:text-[#FF6D42]">
                ...
                <li>
                  <a href="{{ $twitter }}" rel="noreferrer" target="_blank" class="font-bold text-gray-900 transition hover:text-[#FF6D42]">
