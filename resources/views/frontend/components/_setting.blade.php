<div class="hidden2 flex flex-col w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] transition-all duration-300 z-50 px-4 lg:px-[35px]" id="menubar" :class="filterOpen ? 'left-0' : '-left-full'" x-cloak>
  ...
  <div class="divide-y">
          ...
          <div class="duration-300 px-0 pb-3">
            <div class="flex w-full pt-1 px-1">
              <div x-data="select()" class="relative w-full z-50" @click.outside="openFont = false">
                <button @click="toggle" :class="(openFont) && 'ring-blue-600'" class="flex w-full items-center justify-between rounded border-slate-300 bg-white p-2 ring-1 ring-gray-300">
    ...
    <div class="bg-white py-0 flex flex-col w-full" x-data="{ open:true }">
      <button @click="open = !open" class="flex items-center justify-between py-3 group font-semibold md:font-bold">
        <span class="text-sm font-bold uppercase text-gray-900">Align</span>
        ...
        <div class="overflow-hidden pb-0">
          <div class="duration-300 px-0 pb-3">
            <div class="inline-flex items-center rounded-md shadow-sm">
              <button
                class="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-300 rounded-l-lg font-medium px-3 py-1 inline-flex items-center">
                <span>
              ...
              <button
                class="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border-y border-slate-300 font-medium px-3 py-1 inline-flex items-center">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
              ...
              <button
                class="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-300 rounded-r-lg font-medium px-3 py-1 inline-flex  items-center">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
