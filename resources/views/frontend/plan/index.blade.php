				...
				<div class="flex flex-grow flex-col p-6 space-y-3 border rounded shadow sm:p-8 bg-white" >
					...
					<ul class="flex-1 mb-6 text-slate-900">
						<li class="flex mb-1 space-x-2 text-blue-600">
							...
							<span class="text-slate-800">Copy content</span>
						</li>
						<li class="flex mb-1 space-x-2 text-blue-600">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="flex-shrink-0 w-6 h-6 dark:text-violet-600">
								<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
							</svg>
							<span class="text-slate-800">Downloadable content</span>
						</li>
						<li class="flex mb-1 space-x-2 text-blue-600">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="flex-shrink-0 w-6 h-6 dark:text-violet-600">
								<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
							</svg>
							<span class="text-slate-800">Setting content</span>
						</li>
					</ul>
					<a href="{{ route('quotes') }}" class="inline-block px-5 py-2 font-semibold tracking-wider text-center rounded border-2 border-blue-600 bg-blue-600 hover:bg-white text-white hover:text-blue-600">Let's go</a>
				</div>
			</div>
			...
			<div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0" >
				<div class="flex flex-grow flex-col p-6 space-y-3 rounded border shadow sm:p-8 bg-blue-600 text-white" >
					<div class="space-y-1" >
						...
						<span class="text-3xl font-bold text-white"><span class="text-lg font-bold">$</span> {{ $plan->price() }}
