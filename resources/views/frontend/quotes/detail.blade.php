...
@include('frontend.components._info')
<main class="flex flex-col bg-white min-h-full w-full pt-16 md:pt-[70px]">
        ...
        <section class="w-full mx-auto  mt-10 md:mt-10 px-5 pb-10">
          ...
          <div class="flex flex-row  justify-between">
            ...
            <div class="flex space-x-2 justify-end2 md:justify-normal">
              ...
              <button class="bg-[#1b89e0] hover:bg-[#0f82cc] border border-blue-600 px-2 py-1.5 font-extralight text-white inline-flex items-center shadow space-x-1 rounded" title="Copy to clipboard" onclick="copyContent()" value="copy">
          ...
          <div class="py-4 md:py-6 w-full columns-1 ">
            <div class="mb-4 rounded w-full h-0 pt-1/2 pb-1/2 bg-white border group flex flex-col overflow-hidden justify-center shadow-md items-center">
              <div class="flex flex-col justify-center items-center2 px-12 md:px-20">
                ...
                <p id="myText" class="leading-tight md:leading-snug text-wrap text-black text-center text-xl md:text-xl lg:text-2xl">
                  {{ $quote->words }}
                </p>
                <div class=" px-2 py-4 flex justify-end">
                  <a href="{{ url('people/'. $slug) }}" class=" flex justify-between space-x-6 md:space-x-2">
                    <div class="flex space-x-2 ">
                      <span class="flex items-center justify-center text-sm text-[#171717BF] poppins-medium font-semibold">
                        {{ $author }}
                      </span>
                    </div>
                  </a>
              ...
              <div class="flex flex-wrap gap-x-2 w-full">
                ...
                <a href="{{ url('quotes/tag/' . $tg) }}">
                  <div class="py-0.5 px-2.5 bg-[#f1f5f9] border border-slate-300 rounded-sm flex items-center gap-x-1 hover:bg-slate-200 transition cursor-pointer">
                    <div class="truncate text-xs tracking-wide text-black font-semibold poppins-light capitalize">
                      {{ $t }}
                    </div>
                  </div>
                </a>
