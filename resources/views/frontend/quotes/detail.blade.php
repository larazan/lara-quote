      ...
      <div class="flex flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
        ...
        <section class="w-full mx-auto  mt-10 md:mt-10 px-5 pb-10">
          ...
          <div class="py-4 md:py-6 w-full h-full2 columns-1 ">
            <div class="mb-4 rounded w-full h-[400px] md:h-[600px] bg-white border group flex flex-col overflow-hidden justify-center shadow-md items-center">
              <div class="flex flex-col justify-center items-center2 px-12 md:px-20 lg:py-4 md:py-6">
                ...
                <p id="myText" class="leading-tight md:leading-snug text-wrap break-all text-black text-center text-xl md:text-xl lg:text-2xl">
                  {{ $quote->words }}
                </p>
