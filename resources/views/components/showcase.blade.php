<div class="mx-auto w-full2 relative lg:w-full flex flex-col space-y-3 px-3 md:px-6 lg:px-0 py-0 md:py-4 justify-center items-center bg-[#f5f7f9]">
    ...
    <div class="flex flex-row justify-between mx-auto w-full md:w-12/12 lg:w-11/12 space-x-6 items-center pb-7">
        <a href="{{ url('/quotes/' . $id . '/showcase') }}" class="flex rounded px-2 py-1 items-center bg-orange-400 hover:bg-orange-500">
            <span class=" font-semibold text-xs md:text-base text-slate-800">
                All showcase
            </span>
        </a>
    </div>
