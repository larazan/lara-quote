  ...
  <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <nav class="mt-10">
      <a class="flex items-center mt-4 py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 @if(in_array(Request::segment(2), ['dashboard'])){{ 'bg-gray-700 bg-opacity-25 text-gray-100' }}@else{{ 'text-gray-500' }}@endif"
