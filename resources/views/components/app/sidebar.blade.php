        ...
        <div class="ff">
            ...
            <div>
                ...
                <ul class="nk">
                    ...
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['persons'])){{ 'bg-slate-900' }}@else{{ '' }}@endif">
                        <a class="block gj xc ld wt wi" href="{{ url('admin/persons') }}">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Persons</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <!-- Matchs -->
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['riddles'])){{ 'bg-slate-900' }}@else{{ '' }}@endif">
                        <a class="block gj xc ld wt wi" href="{{ url('admin/riddles') }}">
                            <div class="flex items-center">
                                <svg class="ub so oi" viewBox="0 0 24 24">
                                    <path class="du @if(in_array(Request::segment(2), ['riddles'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M8 1v2H3v19h18V3h-5V1h7v23H1V1z"></path>
                                    <path class="du @if(in_array(Request::segment(2), ['riddles'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M1 1h22v23H1z"></path>
                                    <path class="du @if(in_array(Request::segment(2), ['riddles'])){{ 'text-indigo-300' }}@else{{ 'gq' }}@endif" d="M15 10.586L16.414 12 11 17.414 7.586 14 9 12.586l2 2zM5 0h14v4H5z"></path>
                                </svg>
                               
                                <span class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Riddles</span>
                            </div>
                        </a>
                    </li>
                    <!-- News -->
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['blog', 'category-article'])){{ 'bg-slate-900' }}@else{{ '' }}@endif" x-data="{ open: false }">
                        <a class="block gj xc ld wt wi" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center fe">
                                <div class="flex items-center">
                                    <svg class="ub so oi" viewBox="0 0 24 24">
                                        <path class="du @if(in_array(Request::segment(2), ['blog', 'category-article'])){{ 'text-indigo-500' }}@else{{ 'gq' }}@endif" d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"></path>
                                        <path class="du @if(in_array(Request::segment(2), ['blog', 'category-article'])){{ 'text-indigo-500' }}@else{{ 'gz' }}@endif" d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"></path>
                                        <path class="du @if(in_array(Request::segment(2), ['blog', 'category-article'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M13 15.047V24l10.573-7.181A.999.999 0 0024 16V8l-11 7.047z"></path>
                                    </svg>
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 @if(in_array(Request::segment(2), ['blog', 'category-article'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                        ...
                        <div class="tex ttj 2xl:block">
                            <ul class="me re @if(!in_array(Request::segment(2), ['blog', 'category-article'])){{ 'hidden' }}@else{ !block }@endif" :class="open ? '!block' : 'hidden'">
                                <li class="rt ww">
                    ...
                    <!-- Plans -->
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['plans'])){{ 'bg-slate-900' }}@else{{ '' }}@endif">
                        <a class="block gj xc ld wt wi" href="{{ url('admin/plans') }}">
                            <div class="flex items-center">
                                <svg class="ub so oi" viewBox="0 0 24 24">
                                        <path class="du @if(in_array(Request::segment(2), ['plans'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"></path>
                                        <path class="du @if(in_array(Request::segment(2), ['plans'])){{ 'text-indigo-300' }}@else{{ 'gq' }}@endif" d="M12 6a3 3 0 110-6 3 3 0 010 6zm2 18h-4a1 1 0 01-1-1v-6H6v-6a3 3 0 013-3h6a3 3 0 013 3v6h-3v6a1 1 0 01-1 1z"></path>
                                    </svg>
                                <span class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Plans</span>
                            </div>
                        </a>
                    </li>
