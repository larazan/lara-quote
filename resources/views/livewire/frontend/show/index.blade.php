        ...
        <div class="flex flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
          ...
          <section class="w-full mx-auto  mt-10 md:mt-10 px-5 pb-10">
            ...
            <div class="flex flex-row justify-between">
              ...
              <button @click="filterOpen = true"  class="flex justify-between shadow-sm text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-300  rounded-md font-medium px-3 py-2 space-x-1 md:space-x-2 items-center">
