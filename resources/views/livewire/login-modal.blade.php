    ...
    <div>
        ...
        <div wire:click="openLoginModal" class="w-8 h-8 flex items-center justify-center cursor-pointer bg-transparent2 bg-slate-200 hover:bg-slate-300 transition duration-150 rounded-full">
        ...
        <div x-data="{ login: true, register: false, forgot: false }" id="authentication-modal" aria-hidden="true" class="@if($showModal){{ 'block' }}@else{{ 'hidden' }}@endif overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
            <div class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-90">
                <div class="relative w-full max-w-md px-4 h-auto md:h-auto">
                    <!-- Modal content -->
                    <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                        ...
                        <form x-show="register" wire:submit.prevent="register" class="space-y-4 -mt-5 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                            @csrf
