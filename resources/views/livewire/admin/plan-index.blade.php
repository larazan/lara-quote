<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Plan</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <form class="y">
                ...
                <button class="g w j kk" type="submit" aria-plan="Search">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Plan</span>
            </button>
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <!-- <div class="y" x-data="{ open: false, selected: 2 }">
                <button class="btn fe un bg-white border-slate-200 hover--border-slate-300 text-slate-500 hover--text-slate-600" aria-plan="Select date range" aria-haspopup="true" @click.prevent="open = !open" :aria-expanded="open" aria-expanded="false">
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Plans <span class="gq gp"></span></h2>
        </header>
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $plan->name }}</div>
                            </td>
                           
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $plan->stripe_id }}</div>
                            </td>
                            
                            <td class="vi wy w_ vo lm">
                                <div class="gp capitalize">{{ $plan->price }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                @if ($plan->type == 'free')
                                <div class="inline-flex gp hf yl rounded-full gn vp vd">free</div>
                                @endif
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $plan->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $plan->id }})">
    ...
    <x-dialog-modal wire:model="showPlanModal" class="">

        @if ($planId)
        <x-slot name="title" class="border-b">Update Plan</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Plan</span>
        </x-slot>
        @endif
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="flex flex-row justify-between">
                                            <div class="col-start-1 sm:col-span-3">
                                                ...
                                                <input wire:model="stripeId" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                            </div>
                                            <div class="col-start-1 sm:col-span-3">
                                                <label for="title" class="block text-sm font-medium text-gray-700">
                                                    Stripe Name
                                                </label>
                                                <input wire:model="stripeName" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="first-name" class="block text-sm font-medium text-gray-700">Type</label>
                                            <select wire:model="type" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closePlanModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($planId)
                    <x-button wire:click="updatePlan" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createPlan" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
