<section class="container mx-auto font-mono">
    <div class="w-full flex mb-4 p-2 items-center justify-between">
        <h3 class="text-gray-700 text-3xl font-medium">Person</h3>
            ...
            <table class="w-full">
                ...
                <tbody class="bg-white">
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="px-4 py-3 text-ms font-semibold border">{{ $person->slug }}</td>
                        <td class="px-4 py-3 text-ms font-semibold border">{{ $person->bio }}</td>
                        <td class="px-4 py-3 text-ms font-semibold border">{{ $person->created_at->format('d-m-Y') }}</td>
    ...
    <x-jet-dialog-modal wire:model="showPersonModal">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6 grid gap-4">
                                ...
                                <div class="">
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <textarea wire:model="bio" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="col-span-6 sm:col-span-3">
        ...
        <x-slot name="footer">
            <x-m-button wire:click="closePersonModal" class="bg-gray-600 hover:bg-gray-800 text-white mr-2">Cancel</x-m-button>
            @if ($personId)
