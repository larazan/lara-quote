...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Quote</span>
            </button>
        </div>
    ...
    <x-dialog-modal wire:model="showQuoteModal" class="">
        ...
        @if ($quoteId)
        <x-slot name="title" class="border-b">Update Quote</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Quote</span>
        </x-slot>
        @endif
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeQuoteModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($quoteId)
                    <x-button wire:click="updateQuote" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createQuote" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
