<section class="container mx-auto  font-mono">
    <div class="w-full flex mb-4 p-2 items-center justify-between">
        <h3 class="text-gray-700 text-3xl font-medium">Tag</h3>
                ...
                <tbody class="bg-white">
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="px-4 py-3 text-sm border">
                            ...
                            <x-m-button wire:click="deleteId({{ $tag->id }})" class="bg-red-500 hover:bg-red-700 text-white">Delete</x-m-button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <x-jet-dialog-modal wire:model="showTagModal">
        ...
        <x-slot name="footer">
            <x-m-button wire:click="closeTagModal" class="bg-gray-600 hover:bg-gray-800 text-white mr-2">Cancel</x-m-button>
            @if ($tagId)
