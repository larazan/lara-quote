...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Tag</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Tags <span class="gq gp"></span></h2>
        </header>
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $tag->name }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $tag->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $tag->id }})">
    ...
    <x-dialog-modal wire:model="showTagModal" class="">

        @if ($tagId)
        <x-slot name="title" class="border-b">Update Tag</x-slot>
        @else
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeTagModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($tagId)
                    <x-button wire:click="updateTag" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createTag" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
