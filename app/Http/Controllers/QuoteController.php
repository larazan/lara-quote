...
class QuoteController extends Controller
{
    public function __construct()
    {
        ...
        $styles = [
            ...
            [ 'font' => "Chinese-Rocks", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#f64849', 'fontColor' => '#000' ],
            ...
            [ 'font' => "MightyKingdom", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#ffc0ca', 'fontColor' => '#fff' ],
            ...
            [ 'font' => "Peace", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#37a5e4', 'fontColor' => '#fff' ],
            ...
            [ 'font' => "Saolice", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#7f60be', 'fontColor' => '#ffffb3' ],
            [ 'font' => "SimpalaExtended", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#6f9bcc', 'fontColor' => '#fff' ],
            ...
            [ 'font' => "Tahu", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#ab8262', 'fontColor' => '#f2c4c4' ],
            ...
            [ 'font' => "WallabysJunior", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#fbf4e4', 'fontColor' => '#000' ],
            ...
            [ 'font' => "Domine-Regular", 'fontSize' => '14px', 'fontBold' => '14px', 'bgColor' => '#f29b8f', 'fontColor' => '#000' ],
